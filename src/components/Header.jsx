                          ...
                          <div className="menu-bottom d-flex align-items-center gap-5">
                              <div>
                                  <div className="dropdown">
                                      ...
                                      bg-transparent border-0 gap-3 d-flex align-items-center"
                                          type='button'
                                          id='dropdownMenu'
                                      ...
                                      <ul className="dropdown-menu" aria-labelledby='dropdownMenu'>
                                          <li><Link className='dropdown-item text-white' to=''>Blazers</Link></li>
                                          <li><Link className='dropdown-item text-white' to=''>Suits</Link></li>
                                          <li><Link className='dropdown-item text-white' to=''>Boots</Link></li>
                                      </ul>
                                  </div>
                              </div>
